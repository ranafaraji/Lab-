...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        btnSave.setEnabled(false);
        tblFeatures.setEnabled(false);
        btnAddFeatures.setEnabled(false);
        btnRemoveFeatures.setEnabled(false);
    ...
    private void saveFeatures() {
        DefaultTableModel model = (DefaulttabelModel) tblFeatures.getModel();
        
        for (int i = 0; i < model.getRowCount(); i++){
            Features currentFeature = product.getFeatures().get(i);
            currentFeatures.setName(tblFeatures.getValuAt(i, 0).toString());
            currentFeatures.setValue(tblFeatures.getValueAt(i, 1));
        }
    ...
    private void btnAddFeatureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddFeatureActionPerformed
        ...
        Features newFeatures = product.addNewfeatures();
        newFeatures.setName("New Features");
        newFeatures.setValue("Type Value here");
